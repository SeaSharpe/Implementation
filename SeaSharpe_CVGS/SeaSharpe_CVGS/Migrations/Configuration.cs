    ...
    public sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            {            // Game Name                               Release Date        Price        Platform                                        Image                                                                                      Publisher                       Categories ( Can list none or many )
                ...
                MakeGame("Star Craft II: Legacy of the Void",   "2015-11-06 00:00:00",  50.00m, PlatformEnum.PC,    "https://upload.wikimedia.org/wikipedia/en/7/77/StarCraft_II_-_Legacy_of_the_Void_cover.jpg",                               "Blizzard Entertainment",   RatingEnum.T,   CategoryEnum.RTS),
